...
def make_tf_records():
    ...
    write_tf_records_tongue_vein_pack("train_tongue_vein.tfrecords", train_inputs_addrs, train_tongue_label_addrs,train_vein_label_addrs)
    write_tf_records_tongue_vein_pack("val_tongue_vein.tfrecords",  val_inputs_addrs, val_tongue_label_addrs, val_vein_label_addrs)
    write_tf_records_tongue_vein_pack("test_tongue_vein.tfrecords", test_inputs_addrs, test_tongue_label_addrs, test_vein_label_addrs)
